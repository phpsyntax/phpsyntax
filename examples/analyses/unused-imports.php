 ...
 *
 * Demonstrates: NameResolver, `NameNode::$role`, `NameNode::isReference()`, `UseItemNode::$fullName`,
 *               `Node::remove()`, `UseNode::addImport()`
...
foreach ($file->find(NameNode::class) as $name) {
	if ($name->role === SymbolKind::ClassLike && $name->isReference()) {

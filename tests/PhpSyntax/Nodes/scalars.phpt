...
use PhpSyntax\Nodes\Expression\{ArrayAccessNode, ConstantFetchNode};
use PhpSyntax\Nodes\Scalar\{BooleanNode, FloatNode, HeredocNode, IntegerNode, InterpolatedStringNode, NullNode, StringNode, UnquotedStringNode};

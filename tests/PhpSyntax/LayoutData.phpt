...
/**
 * The generated layout roles cover every slot of every node class, and nothing else: a slot without a role
 * is a line a tool laying out code would leave alone without saying so.
 */

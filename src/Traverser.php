...
final class Traverser
{
	...
	/**
	 * Walks the tree; a callback returns `DontTraverseChildren` to keep the walk out of a subtree, or
	 * `StopTraversal` to end it: no node is entered after that, and the ones already entered are left as the
	 * walk unwinds, the node that stopped it among them. Anything else (a value of its own, or nothing)
	 * leaves the walk alone.

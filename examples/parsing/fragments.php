...
// the four are shortcuts; parseFragment() parses an item of a list, a member, a parameter, an argument,
// an array item and the like, which is what an insertion into a class body or a signature needs
...
// on its edges, so printing it gives the node alone, ready to be put somewhere

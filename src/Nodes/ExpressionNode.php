...
use PhpSyntax\Nodes\Expression\{ArrayAccessNode, ArrayNode, ClassConstantFetchNode, ConstantFetchNode, FunctionCallNode, MethodCallNode, ParenthesizedNode, PropertyFetchNode, StaticMethodCallNode, StaticPropertyFetchNode, UnaryOpNode, VariableNode};
...
abstract class ExpressionNode extends Node
{
	...
	public function toValue(): mixed
	{
		...
		return $value === null
			? throw new \LogicException("Expression '$this->text' has no value of its own.")
			: $value[0];
	}

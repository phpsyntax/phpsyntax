 ...
 * a language, or marked `text`, is compared with a real run, chunk by chunk, where `...` stands for
 * anything left out. The PHP blocks of the project readme are checked to parse.
...
/** The content of the first fenced block that carries no language, or `text`, which is how output is quoted. */

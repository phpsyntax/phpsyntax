...
final class NameResolver
{
	...
	{
		if (!$name->isReference()) {
			throw new \InvalidArgumentException("'{$name->text}' refers to no symbol to resolve: it declares one, names a builtin type, or stands for a class only where it is written.");
		}
